...
X_t = load('.\data\X_t_4000_cartpole_walls_2tau_half.csv');
X_tp1 = load('.\data\X_tp1_4000_cartpole_walls_2tau_half.csv'); % assuming passive data
...
save(fullfile('koopman_models', ...
    ['best_tau_' num2str(tau) '_obs_' num2str(length(koop_model.A)-5) '_eps_' num2str(koop_model.epsilon) '_' num2str(left_loc) '_wall_' num2str(right_loc) '.mat']), 'koop_model');