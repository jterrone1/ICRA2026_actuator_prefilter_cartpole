...
X_t = load('X_t_500001_cartpole_2_passive_0.2.csv');
X_tp1 = load('X_tp1_500001_cartpole_2_passive_0.2.csv'); % assuming passive data

%comparison_t = load('X_t_100_cartpole_0.01dt_comparison.csv');
%comparison_tp1 = load('X_tp1_100_cartpole_0.01dt_comparison.csv'); % assuming passive data
...
save(fullfile('koopman_models', ...
    ['tau_' num2str(tau) '_obs_' num2str(n) '_eps_' num2str(eps) '_wall_' num2str(right_loc) '.mat']), 'koop_model');
